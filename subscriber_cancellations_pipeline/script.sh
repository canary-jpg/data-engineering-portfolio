...
#prompts user to confirm before cleansing the data
...
then
    ...
    #delimiting will result in a list of 2 elements
    ...
    then
        #tell the use that the dev and prod changes are different
